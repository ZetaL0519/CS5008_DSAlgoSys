...
// This, means node1->node2 is a 1 in the graph.
// It may not necessarily be true that node2 is connected
// to node1 however.
//  'isConnected' could be renamed 'hasPath' if that
//  makes this more clear.
int isConnected(int* g, int node1, int node2){
    return g[node1 * ROWS + node2] == 1;
}
