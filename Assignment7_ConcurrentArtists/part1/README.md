...
- Q: How can I debug this assignment
	- A: One other tip may be to *fix* one of the artists to be a particular color, say artist '5' will always draw in black pixels (r,g,b values of 0,0,0), then you can study the behavior of particular artists.
